...
name <- "BlackWomeninData"  # Assigns the string "BlackWomeninData" to variable name
...
Now Let's try a simple exercise of creating a school data frame using a tibble format.

### What is A Tibble?
A tibble is a modern version of a data frame in R, which is part of the tidyverse collection of packages. Tibbles provide a more user-friendly and efficient way to handle data. 

```{r ex6-print, exercise=TRUE}
